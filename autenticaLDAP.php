...
$ldapServer = '******'; //Nombre o IP del servidor de autenticacion LDAP
$cadenaBusqLDAP = '*******'; //Cadena de busqueda en el servidor.
$campoBusqLDAP = 'sAMAccountName'; //Campo seleccionado (de las variables LDAP)
//$adminLDAP = 'OU=Bogota,OU=Colombia,OU=Construction,OU=Users_OHL,DC=ohl,DC=es';
$adminLDAP = '*****';
$paswLDAP = 'aparte';
