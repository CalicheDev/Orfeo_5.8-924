...
<?php $fechah = date("Ymdhms") ?>
    ...
    <body  style="overflow: hidden;" onload="modalinfo()">
        ...
        <div id="bottomMenu" class="bot" style="visibility: hidden;">
            <nav>
                <ul>
                    <li><a href="#" onclick="contentMainFrame.changedepesel(10);
                            contentMainFrame.seleccionBarra = 10;"><span data-toggle="tooltip" data-placement="top" title="Mover A" class="glyphicon glyphicon-play"></span></a></li>
                    ...
                    <li><a href="#" id="VOBO"><span  data-toggle="tooltip" data-placement="top" title="Visto Bueno" onclick="contentMainFrame.vistoBueno();contentMainFrame.seleccionBarra = 14;" class="glyphicon glyphicon-ok-sign "></span></a></li>
                    <li><a href="#" onclick="contentMainFrame.changedepesel(61);contentMainFrame.seleccionBarra = 61;"><span data-toggle="tooltip" data-placement="top" title="Aplicar TRD" class=""><img src="estilos/orfeo50/imagenes50/TRD_1.png" alt="Aplicar TRD" style="width: 29px;height: 29px;margin-top: -3px;" /></span></a></li>
                    ...
                    <li><a href="#" id="archivarPerm" style="visibility: hidden" onclick="contentMainFrame.changedepesel(13);
                            contentMainFrame.seleccionBarra = 13;"><span data-toggle="tooltip" data-placement="top" title="Archivar" class="glyphicon glyphicon-folder-open"></span></a></li>
                    <li><a href="#" id="NRR" ><span data-toggle="tooltip" data-placement="top" title="No requiere respuesta" onclick="contentMainFrame.changedepesel(16);
                            contentMainFrame.seleccionBarra = 16;"><img src="estilos/orfeo50/imagenes50/propuesta_3_nrr.png" alt="No requiere respuesta" style="width: 29px;height: 29px;margin-top: -3px;" /></span></a></li>
