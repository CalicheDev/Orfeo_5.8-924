...
include "parametrizador/_config/_config.php";
...
require_once 'parametrizador/pages/header.php';
...
if ($_GET['p'] != 'menuParametrizcion') {
    require_once 'parametrizador/pages/' . $pagina . '.php';
} else {
    require_once "parametrizador/pages/menuParametrizcion.php";
}
...
require_once 'parametrizador/pages/footer.php';
?>
