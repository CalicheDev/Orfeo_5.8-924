...
//                    console.log('++++++ '+document.getElementById("tipo_emp_us" + i).value);
                }
            }
...
//                        $existe = 0;
                        ...
                        $sqlTercero = "select NIT_DE_LA_EMPRESA as SGD_CIU_CEDULA, 'Tercero' as TIPO from BODEGA_EMPRESAS be WHERE NIT_DE_LA_EMPRESA='$no_documento1_ok'";
                        $sqlNatural = "select SGD_CIU_CEDULA as SGD_CIU_CEDULA, 'Persona Natural' as TIPO from SGD_CIU_CIUDADANO sc WHERE SGD_CIU_CEDULA='$no_documento1_ok'";
                        ...
                        $rsSqlsCLientes = $db->query($sqlTercero . ' union ' . $sqlNatural . ' union ' . $sqlJuridico);
...
//                    echo '--- '.$sqlTercero . ' union ' . $sqlNatural . ' union ' . $sqlJuridico;
                    ...
                    if ($agregar == "AGREGAR" and $tagregar == 1) {                        
                        ...
                        if($existe == 1){
                            ...
                            $isql = "INSERT INTO bodega_empresas( are_esp_secue, identificador_empresa, nit_de_la_empresa, nombre_de_la_empresa, direccion, 
                                    nombre_rep_legal, sigla_de_la_empresa, telefono_1, ID_CONT, ID_PAIS, codigo_del_departamento, codigo_del_municipio) 
                    ...
                    if ($no_documento or $nombre_essp) {
                        ...
                        if ($tbusqueda == 0 or $tbusqueda == 8 and $existe == 0) {
                            ...
                            if ($nombre_essp) {
                                ...
                                $where_split = $sqlConact . " LIKE '%" .$nombre_essp. "%' ".$strtoupper.' '.$strtolower.' '.$ucwords;
                    ...
                    <tr class="<?= $grilla ?>">
                        <td colspan="7">
                            <b>Seleccionar tipo de remitente: </b> <select name="tagregar" id="tagregar" onchange="tipocliente();" class="select form-control" style="width: 98%">
                                ...
                                <option value='1' <?= isset($tipo_emp_us) && $tipo_emp_us == 1 ? 'selected': '' ?>>Tercero</option>
