...
{	if(fechf ("formulario",16)=="ok")
	{
		if (
	 	...
	 	{	
		alert("El Remitente/Destinatario, Direccion Asunto, Tipo de Documento y Dependencia son obligatorios ");	}
	 }
}

function modificar_doc(){
	if (
	document.formulario.documento_us1.value && 
        document.formulario.asu.value != '' && 
        document.formulario.tdoc.value != 0 
                        )
{
...
//  variables a llenar ene l formulario de radicación.
    ...
    <div class="tabbertab" title="<?= $titulo ?>">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                        ...
                        <?php if ($ent == 2 && $Submit3 != 'ModificarDocumentos' && $_SESSION["preRadica"] == 1 && $_SESSION["tpPerRad"][2] == 3) { ?>
                            ...
                            <div style="display: none" id='divradicado'>
                                <b>N&uacute;mero Radicado: </b>
                                <input type='numeric' minlength="18" maxlength="30" name='radinume' id='radinume' value='' onkeypress="return isTextKeyradicado(event)" onChange="validaRadicado();"/>                                                
                            </div>                                    
                        <?php } ?>                                                                                    
                    </div>
                </div><br>
            ...
            <div class="panel panel-default" style="background-color: rgb(246, 246, 246)">
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-3 col-md-3 col-xs-3">
                            <label for="mail_us1">Mail</label><br>
        ...
        unset($municodi);
        ?>
        <div class="container borde_tab" cellpadding="0" cellspacing="1">
            <div class="panel panel-default" style="background-color: rgb(246, 246, 246)">
                <div class="panel-body">
                    <div class="row">
                        <div class="form-group col-lg-12 col-md-12 col-xs-12">
                            <label for="asu">Asunto</label><br> 
                            <textarea id="asu" name="asu" cols="100" class="tex_area form-control" title="Area de texto para escribir el asunto del radicado" maxlength="50000" rows="1"><?php echo $asu; ?></textarea>
                        </div>                                                                        
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-3 col-md-3 col-xs-12">
                            <label for="ane">Descripci&oacute;n de Anexos</label><br>
                        ...
                        <div class="form-group col-lg-3 col-md-3 col-xs-12">
                            <label for="tdoc">Tipo Documental</label><br>
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="form-group col-lg-6 col-md-6 col-xs-12">
                            ...
                            <?php
                            if($ent != 2){
                                echo '</br><input type="text" class=" form-control"/>';
                            }else{
