...
//                include ("$dir_raiz/include/tx/Flujo.php");
                ...
                <table width="95%" border="1" cellspacing="1" cellpadding="0" align="center" class="borde_tab">
                    ...
                    <tr>
                        ...
                        <td class=listado2 >
                            ...
                            SGD_PEXP_PROCEXPEDIENTES WHERE SGD_SRD_CODIGO=$codiSRD  AND SGD_SBRD_CODIGO=$codiSBRD";
  ...
  ?>
   ...
   var dateAvailable1 = new ctlSpiffyCalendarBox("dateAvailable1", "TipoDocu", "fechaExp","btnDate1","<?=$fechaExp?>",scBTNMODE_CUSTOMBLUE);
            ...
            <table border=0 width=95% align="center" class="borde_tab">
                ...
                <center><input name="cerrar" type="button" class="botones_mediano" id="envia22" onClick="opener.regresar(); window.close();" aria-label="Cerrar ventana" value=" Cerra                        r "></c                    enter></TD>
                    </tr>
                    </table>
                    <script>
