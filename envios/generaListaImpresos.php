...
//Fin Modificacion 28112005
		...
		<br>";
                    ...
                    echo '<br>';
                    echo "<b>Para ver la planilla de envio por favor  <a class=vinculos href='$arpdf_tmp' target='" . date("dmYh") . time("his") . "'>Abrir Archivo Pdf</a></b>";
                    echo "<br>";
                    $salida = "csv";
                    echo "<b>Para obtener el archivo csv guarde del destino del siguiente v&iacute;nculo  <a class=vinculos href='$archivo' target='" . date("dmYh") . time("his") . "'>Generado
              </a></b>";
                }
