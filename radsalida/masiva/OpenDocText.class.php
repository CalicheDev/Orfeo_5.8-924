...
//        error_log('################## Paso linea 266 ooxml.class.php ' . $directorio . ' ###### ' . $this->stylesXml);
...
//        error_log('################## Paso linea 373 ooxml.class.php ' . print_r($nombreVar) . ' ###### ' . $tempCab . ' #### ' . $tempCab2 . ' #### ' . $tempCab3);
...
//        error_log('################## Paso linea 475 OpenDoc.class.php ' . $archivoTmp . ' #### ' . $archivoFinal . ' #### ' . $tipoUnitario);
        $esArchivo = false;
...
//                        error_log('################## Paso linea 566 ooxml.class.php '.$filePointer3.' #### '.$filePointer2.' #### '.$filePointer);
                        if ($tamano) {
                ...
                if ($vieneTemp != null) {
                    ...
                    ( $this->debug == true) ? ( $error .= "<CENTER><table class=borde_tab><tr><td class=info>Exec Copia: " . "cp " . $workDIR . $nombreZip[0] . ".odt " . $workDIR . $archivoTmp . " </td></tr></table>" ) : $error = '';
                    exec("cp " . $this->workDir . $nombreZip[0] . ".odt " . $workDIR . $archivoTmp);
                    echo $error;
                } else {
