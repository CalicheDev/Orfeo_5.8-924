...
//    $html  = $htmlE;
        ...
        $encaenti = "../logoEntidad_negro.png";
...
<tbody>
<tr>
<td colspan="2" rowspan="6" align="center"><img src="$encaenti" alt=logo_fnd height=50%></td>
<td colspan="10" rowspan="1" align="center"><small><b>$entidad</b></small></td>
</tr>
<tr align="center">
<td colspan="10" rowspan="1"><small><b>NIT 891.900.853-0</b></small></td>
</tr>
<tr align="center">
...
EOD;
        ...
        echo "</br><h4>Para imprimir la planilla siga el siguiente v&iacute;nculo  <a class=vinculos href='$arpdf_tmp' target='" . date("dmYh") . time("his") . "'>Abrir Archivo Pdf</a></h4>";
        echo "<br>";
        $salida = "csv";
