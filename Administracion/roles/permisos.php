...
$menuOrfeoExpress == true ? $display = '' : $display = 'disabled';
/* ---------------------------------------------------------+
  |                       MAIN                               |
  +--------------------------------------------------------- */
...
<!--            <tr>
            ...
            <table border=1 width=100% class=borde_tab>
                ...
                <tr>
                    ...
                    <td width="30%" height="26" class="listado2">
                        ...
                        ?>
                        <input name="modificaciones" type="checkbox" <?=$display?><?php echo $check ?>> Modificaci&oacute;n de radicado.
                        <span class="glyphicon glyphicon-question-sign tooltips" id="tooltips" data-toggle="tooltip" 
                ...
                <tr>
                    ...
                    <td width="30%" height="26" class="listado2"> 
                        ...
                        ?>
                        <input type="checkbox" name="dev_correo" <?=$display?> <?php echo $check ?>> Devoluci&oacute;n de correspondencia.
                        <span class="glyphicon glyphicon-question-sign tooltips" id="tooltips" data-toggle="tooltip" 
                    ...
                    <td width="30%" height="26" class="listado2"> 
                        ...
                        ?>
                        <input type="checkbox" name="anulaciones" <?=$display?> <?php echo $check ?>> Anulaci&oacute;n de radicado.
                        <span class="glyphicon glyphicon-question-sign tooltips" id="tooltips" data-toggle="tooltip" 
                ...
                <tr>
                    <td width="30%" height="26" class="listado2">
                        ...
                        ?>
                        <input type="checkbox" name="masiva" <?=$display?> <?php echo $check ?>> Radicaci&oacute;n masiva.
                        <span class="glyphicon glyphicon-question-sign tooltips" id="tooltips" data-toggle="tooltip" 
                ...
                <tr>
                    ...
                    <td width="30%" height="26" class="listado2">
                        ...
                        ?>
                        <input type="checkbox" name="s_anulaciones" <?=$display?> <?php echo $check ?>> Solicitar anulaci&oacute;n de radicado.
                        <span class="glyphicon glyphicon-question-sign tooltips" id="tooltips" data-toggle="tooltip" 
                ...
                <tr>
                    ...
                    <td width="30%" height="26" class="listado2">                        
                        ...
                        ?>
                        <input type="checkbox" name="usuaPermRadEmail" <?=$display?> <?php echo $check ?>> Radicaci&oacute;n e-mail.
                        <span class="glyphicon glyphicon-question-sign tooltips" id="tooltips" data-toggle="tooltip" 
                    ...
                    <td width="30%" height="26" class="listado2"> 
                        ...
                        ?>
                        <input type="checkbox" name="env_correo" <?=$display?> <?php echo $check ?>> Envi&oacute; de correspondencia.
                        <span class="glyphicon glyphicon-question-sign tooltips" id="tooltips" data-toggle="tooltip" 
                ...
                <tr>
                    <td height='26' width='30%' class='listado2'>
                        ...
                        ?>
                        <input type="checkbox" name="permBorraAnexos" <?=$display?> <?php echo $check ?>> Puede borrar anexos.
                        <span class="glyphicon glyphicon-question-sign tooltips" id="tooltips" data-toggle="tooltip" 
            ...
            if (isset($_POST['guardar'])) {
                ...
                if (($s_anulaciones) && !($anulaciones) or isset($s_anulaciones)) {
                    $anulacionVariable = 1;
                }
                if (($anulaciones) && !($s_anulaciones) or isset($s_anulaciones)) {
                    $anulacionVariable = 2;
                }
                if (($s_anulaciones) && ($anulaciones) or isset($s_anulaciones)) {
                    $anulacionVariable = 3;
