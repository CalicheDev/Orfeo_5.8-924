...
<!--                    <a href='roles/rol.php' target='mainFrame' class="vinculos">Roles</a><br>
                    <a href='roles/permisos.php' target='mainFrame' class="vinculos">Permisos</a><br>
                    <a href='roles/tiposdocumentales.php' target='mainFrame' class="vinculos">Tipos documentales</a>-->
                </td>
            </tr>
            <tr bordercolor="#FFFFFF">    
