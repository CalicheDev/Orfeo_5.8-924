                ...
                <form name="frmPermisos" action='grabar.php?<?= session_name() . "=" . session_id() . "&$encabezado" ?>' method="post">
                    ...
                    <table width="90%" border="1" cellpadding="0" cellspacing="5" >
                        ...
                        <tr>
                            ...
                            <td width="30%" height="26" class="listado2"> 
                                <input type="checkbox" name="dev_correo" value="$dev_correo" <?=$display?> <?php 
                                if ($dev_correo)
                                    echo "checked";
                                else
                                    echo "";
                            ...
                            <td width="30%" height="26" class="listado2"> <input type="checkbox" name="anulaciones" value="$anulaciones" <?=$display?> <?php
                                if ($anulaciones)
                                    echo "checked";
                                else
                                    echo "";
                        ...
                        <tr>
                            <td width="30%" height="26" class="listado2">
                                <input type="checkbox" name="masiva" value="$masiva" <?=$display?> <?php
                                if ($masiva)
                                    echo "checked";
                                else
                                    echo "";
                        ...
                        <tr>
                            ...
                            <td width="30%" height="26" class="listado2"> 
                                <input type="checkbox" name="s_anulaciones" value="$s_anulaciones" <?=$display?> <?php
                                if ($s_anulaciones)
                                    echo "checked";
                                else
                                    echo "";
                        ...
                        <tr>
                            ...
                            <td width="30%" height="26" class="listado2">
                                <input type="checkbox" name="usuaPermRadEmail" value="$usuaPermRadEmail" <?=$display?> <?php
                                if ($usuaPermRadEmail)
                                    echo "checked";
                                else
                                    echo "";
                            ...
                            <td width="30%" height="26" class="listado2"> <input type="checkbox" name="env_correo" value="$env_correo" <?=$display?> <?php
                                if ($env_correo)
                                    echo "checked";
                                else
                                    echo "";
                        ...
                        <tr>
                            <td height='26' width='30%' class='listado2'>
                                <input type="checkbox" name="permBorraAnexos" value="$permBorraAnexos" <?=$display?> <?php
                                if ($permBorraAnexos)
                                    echo "checked";
                                else
                                    echo "";
