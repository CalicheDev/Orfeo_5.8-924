...
<BODY>
    ...
    <form name="new_product"  action='../reportes/generar_estadisticas_envio.php?<?= session_name() . "=" . session_id() . "&krd=$krd&fecha_h=$fechah&fecha_busq=$fecha_busq&fecha_busq2=$fecha_busq2" ?>' method=post>
        ...
        dateAvailable.dateFormat = "yyyy-MM-dd";
                ...
                <tr>
                    <TD height="26" class='titulos2'><label for="tipo_envio">Tipo de Env&iacute;o</label></TD>
...
//Se limita la consulta al substring del numero de radicado de salida 27092005
                ...
                $guion = "' '";
                include "$dir_raiz/include/query/reportes/querygenerar_estadisticas_envio.php";
...
<br><br>
	    ...
	    $encaenti = "../logoEntidad.jpg";	
           ...
           $encabezado = "<table border=1>
            ...
            echo "<div style='margin-left: 2.5%; margin-top: -353px; font-size: 17px; '>"
            . "Para descargar el <a href='$arpdf_tmp' target='" . date("dmYh") . time("his") . "'>Archivo Pdf</a>"
                    . "</div>";
        }
        ?>
    </form>
