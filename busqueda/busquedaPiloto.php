                ...
                <form method="get" action="<?= $sActionFileName ?>?<?= session_name() . "=" . session_id() ?>&indiVinculo=<?= $indiVinculo ?>&verrad=<?= $verrad ?>&carpeAnt=<?= $carpeAnt ?>&nomcarpeta=<?= $nomcarpeta ?>" name="Search">
                    ...
                    <table  border=1 cellpadding=0 cellspacing=1 class='borde_tabReducido' width="95%" align="center">
                        <tr>
                            ...
                            <td class="listado2" colspan="">
                                <input class="tex_area " id="s_RADI_NUME_RADI" type="text" name="s_RADI_NUME_RADI" maxlength="" value="<?= tohtml($flds_RADI_NUME_RADI) ?>" size="55%" id="cajarad" title="Campo para ingresar el numero del radicado a consultar">
                            </td>
                            <td class="titulos2"><label for="s_DOCTO">Identificacion<br>(T.I,C.C,Nit) </label></td>
                            <td class="listado2" colspan="">
                                <input class="tex_area" id="s_DOCTO" type="text" name="s_DOCTO" maxlength="" value="<?= tohtml($flds_DOCTO) ?>" size="55%" title="Campo para consultar por identificacion de usuario, nit de empresa o numero de suscriptor">
                            </td>
                        </tr>
                        <!--
                        /**
                        ...
                        */
                        ...
                        <tr>
                            ...
                            <td class="listado2"colspan="3">
                                <input class="tex_area" id="s_SGD_EXP_SUBEXPEDIENTE" type="text" name="s_SGD_EXP_SUBEXPEDIENTE" maxlength="" value="<?= tohtml($flds_SGD_EXP_SUBEXPEDIENTE) ?>" size="132%" title="Consultar por expediente">
                            </td>
                        </tr>
                        <tr>
                            <td class="titulos2">
                                ...
                                ?>>
                                <label for="s_solo_nomb"> Buscar por</label>
                            ...
                            <td class="listado2" colspan="3">
                                <input class="tex_area" type="text" id="s_RADI_NOMB" name="s_RADI_NOMB" maxlength="70" value="<?= tohtml($flds_RADI_NOMB) ?>" size="132%" title="Campo para buscar radicados por cualquier palabra">
                            </td>
                        </tr>
                        <tr>
                            <td class="titulos2">
                        ...
                        <tr>
                            <td class="titulos2"><label for="s_entrada"><br> Buscar en Radicados <br></label></td>
                            <td class="listado2" colspan="3">
                        ...
                        <tr>
                            ...
                            <td class="listado2" colspan="3">
                                <select class="select form-control" name="s_RADI_DEPE_ACTU" id="s_RADI_DEPE_ACTU" title="listado con todas las dependencias existentes">
                                    ...
                                    $lookup_s_RADI_DEPE_ACTU = db_fill_array("select DEPE_CODI, DEPE_NOMB from DEPENDENCIA where depe_estado=1 order by DEPE_CODI");
            ...
            function Ciudadano_show($nivelus, $tpRemDes, $whereFlds) {
                ...
                <!--	<td class="titulos4" colspan="3">Tabla de resultados de la consulta</td>-->
                            ...
                            <tr>
                                ...
                                <td class="titulos5"><a class="vinculos" href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=4&FormCIUDADANO_Sorted=<?= $form_sorting ?>&">Tipo Documental</a></td>
<!--                                <td class="titulos5"><font class="ColumnFONT"><a href="" class="vinculos">Tipo</a></td>-->
                                ...
                                <td class="titulos5"><a class="vinculos" href="<?= $sFileName ?>?<?= $form_params ?>FormCIUDADANO_Sorting=14&FormCIUDADANO_Sorted=<?= $form_sorting ?>&">N&uacute;mero Identificaci&oacute;n</a></td> 
...
//                                echo " kkkk $ps_RADI_NOMB";
                            ...
                            //-------------------------------
//                            require_once("../class_control/TipoDocumento.php");
...
//                            $tiposdocumentales = $objTipoDocto->getDatosPermisosTipo();
                            ...
                            $sSQL = "SELECT  " .
                                ...
                                substring(r.RA_ASUN,1,300) as RA_ASUN, 
                                td.sgd_tpr_descrip, " .
                                    $redondeo . " as diasr,
                                r.RADI_NUME_HOJA, 
                                r.RADI_PATH, 
...
//                            $sSQL .= " FROM sgd_dir_drecciones dir, radicado r, sgd_tpr_tpdcumento td, sgd_dt_radicado dt, regional reg, cla_serie cla, sgd_mrd_matrird trd, sgd_rdf_retdocf rdf";
...
//                            	echo "<hr>linea 1052 ........ $consultaTipo<hr>";
//                            	echo '@@@@@@@@@@@@@@@@@@@@@@@@@@ '.print_r($tiposdocumentales);
                            //-------------------------------
                            // Process empty recordset
                            //-------------------------------
                            if ($rs->EOF || !$rs) {
                                echo "<script type='text/javascript'>alert('No se encontraron radicados con los parametros ingresados, intente nuevamente');</script>";
                                ?>
                                <tr>
...
//                        echo "<script type='text/javascript'>alert('Su búsqueda fué exitosa, los resultados se encuentran en la tabla inferior');</script>";
                        ...
                        while ((!$rs->EOF && $rs) && $iCounter < $iRecordsPerPage) {
                            ...
                            if($fld_RADI_NOMB_ENCARGO == ''){
                                $tipoRegDesc = "N/A";
                            }else{
                                $tipoRegDesc = $fld_RADI_NOMB_ENCARGO;
                            }
//                            if ($tipoReg == 1)
...
//                                $tipoRegDesc = "Funcionario";
                            ...
                            $fldASUNTO = str_replace($ps_RADI_NOMB, "<font color=green><b>$ps_RADI_NOMB</b>", $fldASUNTO);
                            //-------------------------------
                            // Busquedas Anidadas
                            //-------------------------------
...
//                                        $linkDocto = "<a class='vinculos' href='../bodega/$fldRADI_PATH' target='Imagen$iii'>yyyy";
                                    } else {
                                       $linkDocto = "<a class=vinculos href='#' onclick=\"alert('Usted no tiene acceso a este tipo documental')\">";
                                    }
//                                    $linkDocto = "<a class='vinculos' href='../bodega/$fldRADI_PATH' target='Imagen$iii'>yyyy";
                                }
                                if (in_array($tdocper, $tiposdocumentales)) {
                                    ...
                                    $linkInfGeneral = "<a class=vinculos href='#' onclick=\"alert('Usted no tiene acceso a este tipo documental')\">";
                                }
//                                $linkInfGeneral = "<a class='vinculos' href='../verradicado.php?verrad=$fldRADI_NUME_RADI&" . session_name() . "=" . session_id() . "&carpeta=8&nomcarpeta=Busquedas&tipo_carp=0'>";
                                $restriccion = true;
                            } else
...
//                                        $linkDocto = "<a class='vinculos' href='../bodega/$fldRADI_PATH' target='Imagen$iii'>";
                                    ...
                                    ?>
                                    <? if (strlen($fldRADI_PATH) && $verImg){ $iii = $iii +1;?>  <?php echo ($linkDocto);}?>
                                    <?= $fldRADI_NUME_RADI ?>
...
//-------------------------------
                        ...
                        switch ($numColumna) {
                            ...
                            case 1 :
                                if ($fila['RADI_PATH'] && $verImg)
                                    $salida = "<a class=\"vinculos\" href=\"{$dir_raiz}bodega" . $fila['RADI_PATH'] . "\" target=\"imagen" . (strlen($fila['RADI_PATH']) + 1) . "\">" . $fila['RADI_NUME_RADI'] . "</a>";
                                else
                                    $salida .= $fila['RADI_NUME_RADI'];
                                break;
                            case 2:
                                if ($verImg)
                                    $salida = "<a class=\"vinculos\" href=\"{$dir_raiz}verradicado.php?verrad=" . $fila['RADI_NUME_RADI'] . "&amp;" . session_name() . "=" . session_id() . "&amp;carpeta=8&amp;nomcarpeta=Busquedas&amp;tipo_carp=0 \" >" . $fila['RADI_FECH_RADI'] . "</a>";
                                else
        ...
        " . $where;
			...
			<td class=\"titulos4\" colspan=\"20\" width=\"2000\" ><a name=\"RADICADO\">$sFormTitle</a></td>
                        ...
                        $paginador->setImagenASC($url_raiz . "iconos/flechaasc.gif");
                        $paginador->setImagenDESC("$url_raiz" . "iconos/flechadesc.gif");
